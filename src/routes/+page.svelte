    ...
    <section id="features" class="features-section">
      ...
      <div class="feature-grid">
        <div class="feature-card glass">
          ...
          <h3>Local-First</h3>
          <p>
            Your memories never leave your device. All processing happens on
            your CPU, ensuring 100% privacy.
          </p>
        </div>
        <div class="feature-card glass">
          <div class="f-icon">⚡</div>
        ...
        <div class="feature-card glass">
          ...
          <p>
            Permanently writes dates and locations directly into your file
            headers for future-proof compatibility.
          </p>
        </div>
      </div>
    </section>
